...
public class ComplaintController {
	...
	ComplaintServiceInteface cs;
	  ...
	  public String bookComplaint( @RequestBody Complaint cp)throws InvalidEngineerIdException, OutOfWarrantyException, InvalidModelNumberException, InvalidClientIdException {
